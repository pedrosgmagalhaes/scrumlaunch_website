<template>
  <div class="case-study">
    <div class="case-study__hero">
      <img
        :src="require('@/assets/images/case-study/vesta/hero.svg')"
        class="case-study__hero_icon"
      />
    </div>
...
.case-study {
  ...
  &__divider-1 {
    margin-bottom: 50px;
    height: 1080px;
    background: #ecf0f3 url('../assets/images/case-study/vesta/divider-1.png')
  ...
  &__divider-2 {
    margin-bottom: 50px;
    height: 1080px;
    background: #0b2850 url('../assets/images/case-study/vesta/divider-2.png')
      center 0 / cover no-repeat;
  }
  ...
  &__divider-3 {
    margin-bottom: 50px;
    height: 1080px;
    background: #ecf0f3 url('../assets/images/case-study/vesta/divider-3.png')
      center 0 / cover no-repeat;
  }

  &__divider-4 {
    height: 1080px;
    background: #ecf0f3 url('../assets/images/case-study/vesta/divider-4.png')
      center 0 / cover no-repeat;
  }
}
