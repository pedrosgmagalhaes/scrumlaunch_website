<template>
  <div class="news">
    ...
    <div class="news--wrapper">
      ...
      >
        <transition-group name="news">
          <div
            v-show="news_item.in_viewport"
            :key="index"
            class="news--wrapper--item--content"
          >
            <div>
              <p class="news--wrapper--item--content--header header-2">
                {{ news_item.title }}
              </p>
              <p class="news--wrapper--item--content--text body-3">
                {{ news_item.shortText }}
              </p>
            </div>
    ...
    <NuxtLink class="btn news--btn" to="/blog">explore more</NuxtLink>
  </div>
</template>
